...
export const renderInclusionIcon = (item) => {
  switch (item.toLowerCase()) {
    case "flight":
      return <PlaneIcon className="w-4 h-4" viewBox="0 0 16 16" />;
    case "hotel":
      return <HotelIcon className="w-4 h-4" viewBox="0 0 16 16" />;
    case "visa":
      return <PassportCircleIcon className="w-4 h-4" viewBox="0 0 16 16" />;
    case "food":
      return <SpoonKnifeIcon className="w-4 h-4" viewBox="0 0 16 16" />;
    case "transport":
      return <BusRedIcon className="w-4 h-4" viewBox="0 0 16 16" />;
    case "guide":
      return <GuideIcon className="w-4 h-4" viewBox="0 0 16 16" />;
    default:
      return null;
  }
};
