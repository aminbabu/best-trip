...
const Filters = async () => {
  ...
  const data = [
    ...
    },
    {
      ...
      value: "umrah",
      component: (
        <UmrahTabpane className="rounded-t-none sm:rounded-tr-md min-h-[174px] shadow-[0_2px_8px_0_rgba(0,0,0,0.07)] lg:shadow-[0_3px_12px_0_rgba(0,0,0,0.03)]" umrahData={umrahData} />
      ),
    },
    {
      id: 3,
