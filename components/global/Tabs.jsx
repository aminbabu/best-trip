      ...
      <TabsList className="h-auto p-0 rounded-b-none rounded-t-md">
        {data.map((tab, index) => (
          <TabsTrigger
            ...
            value={tab.value}
            className={cn(
              "p-3 lg:px-6 lg:py-4 flex-col xs:flex-row gap-1 text-sm lg:text-lg text-t-700 bg-white rounded-none data-[state=active]:bg-p-900 data-[state=active]:text-white data-[state=active]:border-b-p-900",
              {
